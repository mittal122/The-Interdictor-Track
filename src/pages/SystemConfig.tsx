...
import { Settings, FileCode, GitBranch, Clock, ChevronRight, Copy, Check, ShieldAlert } from "lucide-react";
    ...
    <div className="flex h-full flex-col gap-4 overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-zinc-800/50 pb-4 shrink-0">
        ...
        <div className="flex items-center gap-3">
          {user?.role !== "admin" && (
            <div className="flex items-center gap-1.5 px-2 py-1 rounded border border-yellow-900/50 bg-yellow-950/30 text-yellow-500">
      ...
      {/* Main Layout */}
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[220px_1fr_260px] gap-4 min-h-0 overflow-y-auto lg:overflow-hidden pb-4 lg:pb-0">
        {/* File Browser */}
        ...
        {/* Code Viewer */}
        <div className="rounded-xl border border-zinc-800/50 bg-zinc-950/80 overflow-hidden flex flex-col min-h-[400px] lg:min-h-0">
          {/* Code header */}
